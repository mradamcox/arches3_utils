...
def print_to_log(dict_errors,log_dir,missing=[],extra=[]):
    '''print the two error outputs to a log'''

    logfile = os.path.join(log_dir,"_makeentitydoc.log")
...
logpath = print_to_log(errors,log_dir,missing_docs,unused_docs)
try:
